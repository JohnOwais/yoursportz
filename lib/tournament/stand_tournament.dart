...
class StandTournament extends StatefulWidget {
  const StandTournament({super.key, required String phone});

  @override
  State<StandTournament> createState() => _StandTournamentState();
}

class _StandTournamentState extends State<StandTournament> {
