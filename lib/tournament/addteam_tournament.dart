...
import 'package:yoursportz/tournament/addteams_tournament.dart';

class AddteamTournament extends StatefulWidget {
  final String phone;
  const AddteamTournament({super.key, required this.phone});

  @override
  State<AddteamTournament> createState() => _AddteamTournamentState();
}

class _AddteamTournamentState extends State<AddteamTournament> {
