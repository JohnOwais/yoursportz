...
class StandbTournament extends StatefulWidget {
  const StandbTournament({super.key, required this.phone});
  final String phone;

  @override
  State<StandbTournament> createState() => _StandbTournamentState();
}

class _StandbTournamentState extends State<StandbTournament> {
  var about = true;
